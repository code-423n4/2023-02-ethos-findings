...
[G-02] Use latest Solidity version with a stable pragma statement.
Using a floating pragma ^0.8.0 and ^0.6.11 statement is discouraged as code can compile to different
