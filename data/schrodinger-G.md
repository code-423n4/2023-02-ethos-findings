...
| |Issue|Instances| |
|-|:-|:-:|:-:|
| [G-01] | Functions guaranteed to revert when called by normal users can be marked payable | 7 |  
| [G-02] | Optimize names to save gas | 12 | 
| [G&#x2011;03] | `++i` costs less gas than `i++`, especially when it’s used in for-loops (--i/i-- too) | 17 | 
| [G&#x2011;04] | State variables only set in the constructor should be declared immutable | 1 | 
| [G&#x2011;05] | `<array>.length` should not be looked up in every loop of a `for`-loop | 6 | 
| [G-06] | Avoid compound assignment operator in state variables | 21 |
| [G-07] | Using `bool`s for storage incurs overhead | 8 |
| [G-08] | Using storage instead of memory for structs/arrays saves gas | 5 |
...
=> **there are total 17 instances found for [G-2]:**
...
## [G-6] Avoid compound assignment operator in state variables
